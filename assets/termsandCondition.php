...
<body class="poppage" oncontextmenu="return false" ondragstart="return false;" ondrop="return false;">
	...
	<h2> PLEASE READ THE TERMS CAREFULLY BEFORE USING THIS SITE </h2>
	...
	<h3> ORDERS</h3>
	<p> Orders must be received via the internet by completing the relevant Order Form, which can be found at the online shop. Your order is received by us at the time you submit your delivery data and the desired quantity through the Order Form. Order details are available on the screen of the user after the completion of the order.</p>
